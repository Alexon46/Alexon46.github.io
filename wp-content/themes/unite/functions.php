...
function func_toshow_posts( $atts ){
global $post;
$args = array( 'posts_per_page' => 5,'post_type'=> 'Performances');
...
$taxonomies = get_the_taxonomies();
	...
	<div class="col-lg-6">
	    ...
	    <label for=""><span class="glyphicon glyphicon-dashboard"></span>Дата:<?php echo get_field('дата_премьеры')?></label>
	    <label for=""><span class="glyphicon glyphicon-usd"></span>Стоимость:<?php echo get_field('стоимость_билета_')?></label>
		<div><span class="glyphicon glyphicon-exclamation-sign"></span><br><?php echo
        implode("</p><p>", $taxonomies )?></div>
	</div>
	<?php
...
add_shortcode( 'formain', 'func_toshow_posts' );
